    ...
    <main className="w-full flex flex-col gap-6 p-4 ">
      ...
      <section className="flex flex-col gap-4 lg:min-h-96">
        <div className=" border-r-2 p-2 text-gray-500  flex flex-col gap-4">
          ...
          <p>
            هدف ما ارائه‌ی کالاهای اصلی، مشاوره تخصصی و خدمات پس از فروش مطمئن
            است تا مشتریان از بابت کیفیت و اصالت کالا آسوده باشند.
          </p>
          <p>
            مدیریت فروش آنلاین، ثبت سفارش‌ها، پاسخگویی به مشتریان و هماهنگی
            ارسال کالا توسط واحد فروش اینترنتی فروشگاه انجام می‌شود تا مشتریان
            بتوانند در کوتاه‌ترین زمان ممکن سفارش خود را ثبت و پیگیری کنند.
          </p>
        </div>
      </section>
