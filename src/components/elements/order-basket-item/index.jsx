...
const OrderBasketItem = ({ order }) => {
  ...
  return (
    <div
      className={`border rounded-[8px] p-2 flex flex-col  items-center  gap-2 text-gray-500 w-full `}
    >
      ...
      <div className="w-full  flex  items-center md:flex-row-reverse  gap-4  h-10">
        <OrderAddToCart
